...
import 'package:mind_mingle/postjobq.dart';
          ...
          children: [
            ...
            SizedBox(
              ...
              child: Padding(
                ...
                child: Image.asset('assets/images/postjobpic.png',width: 700,),
              ),
            ),
            const Padding(
              ...
              child: Align(
                alignment: Alignment.topLeft,
                  child: Text("Come hire with us",style: TextStyle(fontWeight: FontWeight.w600,fontSize: 20,color: Colors.black87),)),
            ),
            const Padding(
              padding: EdgeInsets.only(left: 10.0),
              child: Text('Find the best talent through our app in a seamless manner.',style: TextStyle(fontWeight: FontWeight.w500,fontSize: 13,color: Colors.blueGrey),),
            ),
            Uihelper.CustomButton(() {
              Navigator.push(context, MaterialPageRoute(builder: (context)=>const PostJobQuestions()));
            }, "Start Hiring")
          ],
        ),
      )
